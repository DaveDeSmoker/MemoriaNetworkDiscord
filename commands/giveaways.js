...
module.exports.run = async (bot, message, args) => {
    ...
    var winnerCount;
    var d = new Date,
    dformat = [d.getMonth()+1,d.getDate(),[d.getHours(),d.getMinutes()].join(':');
    ...
    var giveawayEmbed = new discord.RichEmbed()
        ...
        .addField("Deze giveaway eindigd op", date)
        .setTimestamp()
    ...
    setTimeout(function () {
        ...
        if (peopleReacted.length == 0) {
            return message.channel.send("Er heeft helaas niemand meegedaan!");
        }
 
        // Tijdelijk kijken we na als er te wienig mensen hebben mee gedaan aan de wedstrijd.
        if (peopleReacted.length < winnerCount) {
            return message.channel.send("Er hebben niet genoeg mensen mee gedaan!");
        }
