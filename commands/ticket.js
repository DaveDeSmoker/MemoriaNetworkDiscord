...
client.on('message', message => {
     ...
     * get rid of it.
     */
    if(message.content.toLowerCase() === '!ticket' && message.channel.id === '604450345179021314') {
        ...
        message.guild.channels.some(channel => channel.name.toLowerCase() === message.author.username + 's-ticket')) {
            message.author.send("Je hebt al een ticket!");
        } 
        else {
    ...
    else if(message.content.toLowerCase() === '!ticket') { // Closing the ticket.
